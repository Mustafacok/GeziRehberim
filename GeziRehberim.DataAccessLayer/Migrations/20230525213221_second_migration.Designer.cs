...
namespace GeziRehberim.DataAccessLayer.Migrations
{
    ...
    [Migration("20230525213221_second_migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeziRehberim.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeziRehberim.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GeziRehberim.EntityLayer.Concrete.CustomerAccount", b =>
                {
            ...
            modelBuilder.Entity("GeziRehberim.EntityLayer.Concrete.CustomerAccountProcess", b =>
                {
            ...
            modelBuilder.Entity("GeziRehberim.EntityLayer.Concrete.CustomerAccount", b =>
                {
                    b.HasOne("GeziRehberim.EntityLayer.Concrete.AppUser", "AppUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("GeziRehberim.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("GeziRehberim.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
